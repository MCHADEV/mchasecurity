...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(callicolor)
      .setImage(`https://media.discordapp.net/attachments/902213944205266954/915543760736251904/20211029_112216-1.jpg`)
      .setDescription(`
👑 OwnerCode 
...
(Anti !       Smart | 𝗠 𝗖 𝗛 𝗔 #7674)
      `)
      .setThumbnail(`https://media.discordapp.net/attachments/902213944205266954/915543760736251904/20211029_112216-1.jpg`)
    message.channel.send({https://media.discordapp.net/attachments/902213944205266954/915543760736251904/20211029_112216-1.jpg});
  }
});
///////////////////////////////////////////////////////////////////////////////
calli.login("")
